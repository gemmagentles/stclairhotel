<!-- Clone -->        
<?php if ( have_rows( 'half_and_half_panel_purple_half_and_half_panel_default' ) ) : ?>
<div class="half-and-half-panel__wrapper half-and-half-panel__purple">
    <?php while ( have_rows( 'half_and_half_panel_purple_half_and_half_panel_default' ) ) : the_row(); ?>
